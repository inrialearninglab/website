...
Pour accéder à plus d'informations sur le **programme du cours** et **vous inscrire dès maintenant** [rendez-vous sur la plateforme FUN](https://www.fun-mooc.fr/courses/course-v1:inria+41018+session01/about).

Début du cours le **15 mars 2019.**

Ce cours est proposé par [_Inria_](https://www.inria.fr/) en collaboration avec de nombreux contributeurs, avec le soutien du [_Ministère de l'Education Nationale_ _et de la Jeunesse_](http://www.education.gouv.fr/) et en partenariat avec [_Class' Code_](https://pixees.fr/classcode-v2/).
