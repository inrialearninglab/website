...
Dans le cadre de cet atelier, expérimentez des **techniques d'implication** à travers des exemples, pour apprendre à les mettre en pratique avec votre public :

- A quoi sert la participation, que produit-elle ?
- Quelles sont les méthodes de co-construction et les techniques participatives ?
- Comment identifier les politiques et les projets auxquels associer les individus ?
- Comment dimensionner et mettre en œuvre la consultation (en séance, en ligne ou dans une hybridation des deux) ?
- Quelles solutions digitales utiliser, du local au global, selon l'objectif poursuivi ?
