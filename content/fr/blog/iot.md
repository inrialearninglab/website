...
A la fin de ce cours chaque participant sera capable de développer une application IoT de l'objet au cloud. Il n'est pas nécessaire de posséder de matériel spécifique pour suivre ce cours : chacun pourra programmer et tester son logiciel en utilisant la plateforme d'expérimentation [FIT IoT-Lab](https://www.iot-lab.info/).
...
- des **tutoriels**,
- des **quiz**
- et des **activités pratiques** avec l'utilisation de **notebooks Jupyter** et de la plateforme **[FIT IoT-Lab](https://www.iot-lab.info/)**.
...
- [Information et inscription](https://www.fun-mooc.fr/fr/cours/internet-things-microcontrollers-hands-course-linternet-des-obje/) sur la plateforme Fun-Mooc
- [Twitter : #MoocIoT](https://twitter.com/search?q=MoocIoT&src=typd)
